                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="app" data-parent="#accordionExample">
                            <li>
                                <a href="apps_chat.html"> Add Client </a>
                            </li>
                            <li>
                                <a href="apps_mailbox.html"> View Client  </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="components" data-parent="#accordionExample">
                            <li>
                                <a href="component_tabs.html"> Add Plan </a>
                            </li>
                            <li>
                                <a href="component_accordion.html"> View Plan  </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="elements" data-parent="#accordionExample">
                            <li>
                                <a href="element_alerts.html"> Add Enquiry </a>
                            </li>
                            <li>
                                <a href="element_avatar.html"> View Enquiry </a>
                            </li>
                        </ul>
                    </li>
...
<!--                    <li class="menu">
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="datatables" data-parent="#accordionExample">
                            <li>
                                <a href="table_dt_basic.html"> Add Subscription </a>
                            </li>
                            <li>
                                <a href="table_dt_basic-dark.html"> View Subscrption </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="forms" data-parent="#accordionExample">
                            <li>
                                <a href="form_bootstrap_basic.html"> Check-IN </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="users" data-parent="#accordionExample">
                            <li>
                                <a href="user_profile.html"> Add Expense </a>
                            </li>
                            <li>
                                <a href="user_account_setting.html"> View Expense </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="pages" data-parent="#accordionExample">
                            <li>
                                <a href="pages_helpdesk.html"> System Setting </a>
                            </li>
                            <li>
                                <a href="pages_contact_us.html"> Email Setting </a>
                            </li>
                            <li>
                                <a href="pages_faq.html"> SMS Setting </a>
                            </li>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="authentication" data-parent="#accordionExample">
                            <li>
                                <a href="auth_login_boxed.html"> Add User </a>
                            </li>
                            <li>
                                <a href="auth_register_boxed.html"> View Users </a>
                            </li>
                        </ul>
                    </li>
                    <li class="menu">
